...
import { ErrorWrapper, InnerWrapper, Wrapper, Label, Input } from './customInput.styled';
  ...
  return (
    <Wrapper>
      <InnerWrapper>
        ...
        <Input id={id} type={type} onChange={handleChange} onBlur={handleBlur} value={values[fieldName]} />
